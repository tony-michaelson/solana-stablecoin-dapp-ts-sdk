...
export const buyBurnMataInstruction = async ({
  config,
  connection,
  payer,
  amm,
  lamports,
}: BuyBurnMata): Promise<Instructions & Signers> => {
  switch (amm) {
    case Amm.Orca:
      return spendArbFundsForMataUsingOrca({
        config,
        connection,
        payer,
        amm,
    ...
    case Amm.Raydium:
      return spendArbFundsForMataUsingRaydium({
        config,
        connection,
        payer,
        amm,
...
const spendArbFundsForMataUsingOrca = async ({
  config,
  connection,
  payer,
  amm,
...
const spendArbFundsForMataUsingRaydium = async ({
  config,
  connection,
  payer,
  amm,
